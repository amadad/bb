...
describe("ThreadTableOfContents", () => {
  ...
  it("overlays the live timeline window on the full conversation outline", async () => {
    setOutline([
      {
        id: "row_user_1",
        role: "user",
        preview: "First stored question",
        attachmentSummary: null,
      },
      {
        id: "row_user_2",
        role: "user",
        preview: "Second stored question",
        attachmentSummary: null,
      },
      {
        id: "row_user_3",
    ...
    expect(await screen.findByText("First stored question")).not.toBeNull();
    expect(screen.getByText("Second stored question")).not.toBeNull();
    expect(
